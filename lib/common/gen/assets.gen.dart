...
class $AssetsIconsGen {
  ...
  SvgGenImage get asosiySelected =>
      const SvgGenImage('assets/icons/asosiy_selected.svg');

  /// File path: assets/icons/asosiy_unselect.svg
  ...
  /// File path: assets/icons/calendar_days.png
  AssetGenImage get calendarDays =>
      const AssetGenImage('assets/icons/calendar_days.png');
  ...
  /// File path: assets/icons/hisob_unselect.svg
  ...
  AssetGenImage get kunSavoli =>
      const AssetGenImage('assets/icons/kun_savoli.png');

  /// File path: assets/icons/kundalik_icon.png
  ...
  /// File path: assets/icons/maqolalar_select.svg
  SvgGenImage get maqolalarSelect =>
      const SvgGenImage('assets/icons/maqolalar_select.svg');
  ...
  /// File path: assets/icons/ogriq_bartaraf.png
  AssetGenImage get ogriqBartaraf =>
      const AssetGenImage('assets/icons/ogriq_bartaraf.png');
  ...
  /// File path: assets/icons/yordamchi_unselect.svg
  SvgGenImage get yordamchiUnselect =>
      const SvgGenImage('assets/icons/yordamchi_unselect.svg');
